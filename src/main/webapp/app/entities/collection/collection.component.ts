...
export class CollectionComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.collectionService
      ...
      .subscribe((res: HttpResponse<ICollection[]>) => this.paginateCollections(res.body, res.headers));
  }
  ...
  trackId(index: number, item: ICollection) {
    return item.id;
  }
  ...
  protected paginateCollections(data: ICollection[], headers: HttpHeaders) {
