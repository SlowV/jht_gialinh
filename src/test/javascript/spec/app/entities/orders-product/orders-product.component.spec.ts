...
import { OrdersProductComponent } from 'app/entities/orders-product/orders-product.component';
...
describe('Component Tests', () => {
  describe('OrdersProduct Management Component', () => {
    let comp: OrdersProductComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(OrdersProductComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.ordersProducts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
